    ...
    <BrowserRouter>
      <header className="w-full flex justify-between items-center bg-white sm:px-8 px-4 py-4 border-b border-b-[#e6ebf4]">
        ...
        <div className="flex flex-col gap-1">
          <Link
            to={"/create-post"}
            className="font-inter font-medium bg-[#6469ff] text-white px-4 py-2 rounded-md mr-3 w-full">
            Create
          </Link>
          <Link
            to={"/"}
            className="font-inter font-medium bg-[#6469ff] text-white block px-4 py-2 rounded-md w-full">
            Community Showcase
          </Link>
        </div>
      </header>
